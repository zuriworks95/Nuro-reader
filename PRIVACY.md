...
**Nuro collects no personal data.**
...
opening Nuro's "Details" page, and removing the extension — or by
...
- **`<all_urls>`** host permission — required so Nuro's reading aids can
  apply on any website you visit. The content script only reads and
  modifies the DOM of the page you're on; it never exfiltrates page
  contents.
